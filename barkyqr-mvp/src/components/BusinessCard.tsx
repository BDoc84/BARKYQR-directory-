...
export default function BusinessCard({ listing }: BusinessCardProps) {
  const previewImage = listing.photos.length > 0 ? listing.photos[0] : null;
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-6">
        ...
        <Link
          ...
          className="inline-flex items-center text-bark-blue-600 hover:text-bark-blue-700 font-medium text-sm"
        >
          See More
